({
    ...
    getParams: function(component, event, helper) {
        ...
        console.log('11 '+component.get("v.filter"));
        console.log('12 '+component.get("v.limit"));
        console.log('13 '+component.get("v.object"));
        console.log('14 '+component.get("v.order"));
        console.log('15 '+component.get("v.searchField"));
        console.log('16 '+component.get("v.subtitleField"));
       // debugger;
		//var value1 = component.get("{!v.brand.Id}");
        return {
            filter: filter,
            limit: limit,
            object: object,
    ...
    getRecentRecords: function(component, event, helper) {
		...
		//console.log('333 getParams '+getParams);
        ...
        getRecordsAction.setCallback(this, function(res) {
            ...
            console.log('17 '+returnedRecords);
    ...
    getRecordByValue: function(component, event, helper) {
		...
		console.log('18 '+component.get("v.value"));
        if (!value) {
    ...
    getRecordsBySearchTerm: function(component, event, helper) {
        var searchTerm = component.find('lookupInput').getElement() 
        ...
        console.log('19 '+component.get("v.showRecentRecords"));
        ...
        if ($A.util.isEmpty(searchTerm)) {
            if (showRecentRecords) {
                ...
                console.log('444 '+component.get("v.recentRecords"));
            } else {
        ...
        component.set('v.searchTimeout', setTimeout($A.getCallback(function() {
            ...
            params.filter = params.filter + ' AND Start_Date__c <= today'
