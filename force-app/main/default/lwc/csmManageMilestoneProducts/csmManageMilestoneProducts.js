...
//Apex Controllers.
import getRecords from "@salesforce/apex/CSMManageMilestoneProducts.getRecords";
...
import Search_Placeholder from '@salesforce/label/c.CSM_Manage_Milestone_Product_Place_Holder';
...
export default class CsmManageMilestoneProducts extends LightningElement {
    //API variables.
    @api recordId;
    @api milestoneId;
	@api strDefaultTab;
	...
	objConfiguration = {
		...
		strCardTitle: Manage_Milestone_Product_Title,
	...
	loadRecords() {
		...
		getRecords({
			...
			strMilestoneId: this.milestoneId
		}).then((objResult) => {	
			//We build the tables.
