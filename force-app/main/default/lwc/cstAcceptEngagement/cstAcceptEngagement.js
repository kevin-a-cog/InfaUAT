...
import acceptEngagementRecord from '@salesforce/apex/cstAcceptEngagementController.acceptEngagementRecord';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { CloseActionScreenEvent } from 'lightning/actions';
import { getRecordNotifyChange } from 'lightning/uiRecordApi'; 

export default class CstAcceptEngagement extends LightningElement {
 @api recordId;
 connectedCallback(){
 ...
 acceptHandler(){
    ...
    .then(result => {
        console.log('cstAcceptEngagementController==>  ' );
