...
export default class ESupportFooter extends LightningElement {
    appLogo = ESUPPORT_RESOURCE + '/logo-informatica.svg';
    footerData = [
    {
        id: 1,
    ...
    },
    {
        ...
        link: 'https://www.informatica.com/privacy-policy/personal-informatica.html'
    }];
    ...
    renderedCallback(){
        this.template.querySelector('.footer-year').innerHTML = new Date().getFullYear();
    }
}