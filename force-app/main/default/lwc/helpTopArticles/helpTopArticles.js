/*
* Name : HelpTopArticles
* Author : Deeksha Shetty
* Created Date :  Feb 9 2022
* Description : This Component displays Recent Articles.
Change History
******************************************************************************************************************************
...
import displayArticles from '@salesforce/apex/helpArticles_Documents.displayArticles';
...
export default class HelpTopArticles extends LightningElement {
    @api recordId;
    wiredResults;
    showNoresult = true;
    viewmore;
    ...
    handleSubscribe() {
      ...
      handleMessage(message) {
        this.receivedMessage = message ? message : "no message";
          if (this.receivedMessage.sessiontoken && this.recordId) this.ArticlesDisplay();
      }
    ...
    ArticlesDisplay() {
        displayArticles({ topicId: this.recordId, token: this.receivedMessage.sessiontoken})
            .then((result) => {
                if (result) {
