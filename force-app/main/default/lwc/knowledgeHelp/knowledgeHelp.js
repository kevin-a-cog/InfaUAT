...
import getHelpItems from '@salesforce/apex/KBLWCHandler.getHelpItems';

export default class KnowledgeHelp extends LightningElement {
    ...
    connectedCallback(){
        ...
        getHelpItems().then(result => {           
            ...
            result.forEach(item => {
                this.helpItems.push({id:item.Id,label:item.Item_Label__c,url:item.Link_URL__c,sortOrder:item.Item_Order__c});
            });
            sortHelpItems();
