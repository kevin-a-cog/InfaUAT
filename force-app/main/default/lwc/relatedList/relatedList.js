...
export default class RelatedList extends NavigationMixin(LightningElement) {
    ...
    async init() {
        ...
        this.state.title = this.sectionTitle

        const data = await this.helper.fetchData(this.state);
        console.log('init, data.records = ' + JSON.stringify(data.records));
        ...
        this.state.columns = this.columns; //this.helper.initColumnsWithActions(this.columns, this.customActions)
    }
