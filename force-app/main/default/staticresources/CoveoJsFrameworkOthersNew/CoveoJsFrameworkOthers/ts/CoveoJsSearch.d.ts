...
declare module Coveo {
	class QueryUtils {
	    ...
	    static quoteAndEscapeIfNeeded(str: string, forceEscape?: boolean): string;
	    ...
	    static buildFieldExpression(field: string, operator: string, values: string[], forceEscape?: boolean): string;
	    static buildFieldNotEqualExpression(field: string, values: string[], forceEscape?: boolean): string;
...
declare module Coveo {
	...
	interface IQuerySuggestRenderedArgs {
	    numberOfSuggestions: number;
	}
	/**
...
declare module Coveo {
	...
	class FacetQueryController {
	    ...
	    constructor(facet: Facet, shouldEscapeValueInFieldExpression?: boolean);
	    /**
