...
declare module Coveo {
	...
	class DynamicFacetRequestBuilder {
	    ...
	    buildBaseRequestForQuery(query: IQuery): IFacetRequest;
	}
...
declare module Coveo {
	class DynamicFacetQueryController {
	    ...
	    buildFacetRequest(query: IQuery): IFacetRequest;
...
declare module Coveo {
	...
	class SmartSnippetCollapsibleSuggestion {
	    constructor(questionAnswer: IRelatedQuestionAnswerResponse, bindings: IComponentBindings, innerCSS: string, searchUid: string, source?: IQueryResult);
...
declare module Coveo {
	...
	class SmartSnippetSuggestions extends Component {
	    ...
	    static ID: string;
	    static doExport: () => void;
	    constructor(element: HTMLElement, options?: {}, bindings?: IComponentBindings);
